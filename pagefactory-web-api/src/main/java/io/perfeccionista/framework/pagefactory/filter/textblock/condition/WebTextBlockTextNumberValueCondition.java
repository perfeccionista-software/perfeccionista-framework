...
public class WebTextBlockTextNumberValueCondition implements WebTextBlockCondition {
    ...
    public WebTextBlockTextNumberValueCondition(@NotNull NumberValue<?> expectedNumberValue) {
        this.expectedNumberValue = expectedNumberValue;
    }

    public WebTextBlockTextNumberValueCondition containsTextBlock() {
        return this;
    }

    public WebTextBlockTextNumberValueCondition notContainTextBlock() {
        return this.inverse();
    }

    @Override
    public WebTextBlockTextNumberValueCondition and(@NotNull WebTextBlockCondition condition) {
        childConditions.add(WebTextListBlockConditionHolder.of(AND, condition));
        return this;
    }

    @Override
    public WebTextBlockTextNumberValueCondition or(@NotNull WebTextBlockCondition condition) {
    ...
    private WebTextBlockTextNumberValueCondition inverse() {
        inverse = true;
        return this;
    }
