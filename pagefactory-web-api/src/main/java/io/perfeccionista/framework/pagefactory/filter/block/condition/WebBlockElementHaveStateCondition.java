...
public class WebBlockElementHaveStateCondition<T extends WebBlock> implements WebBlockCondition<T> {
    ...
    public WebBlockElementHaveStateCondition(@NotNull String elementPath,
    ...
    public WebBlockElementHaveStateCondition(@NotNull WebChildElement elementFrame,
                                             @NotNull String stateName) {
    ...
    public WebBlockElementHaveStateCondition<T> haveState() {
        return this;
    }

    public WebBlockElementHaveStateCondition<T> notHaveState() {
        return this.inverse();
    }
    ...
    private WebBlockElementHaveStateCondition<T> inverse() {
        inverse = true;
        return this;
    }
