...
public class WebTableCellElementPropertyStringValueCondition implements WebTableRowCondition {
    ...
    public WebTableCellElementPropertyStringValueCondition(@NotNull String columnName,
    ...
    public WebTableCellElementPropertyStringValueCondition notContainsProperty() {
        return this.inverse();
    }
