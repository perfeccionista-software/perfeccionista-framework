...
public class WebItemElementLabelNumberValueCondition<T extends WebBlock<?>>  implements WebItemCondition<T> {
    ...
    public WebItemElementLabelNumberValueCondition(@NotNull String elementPath, @NotNull NumberValue<?> expectedNumberValue) {
        this.elementPath = elementPath;
        this.elementFrame = null;
        this.expectedNumberValue = expectedNumberValue;
    }

    public WebItemElementLabelNumberValueCondition(@NotNull WebGetTextAvailable elementFrame, @NotNull NumberValue<?> expectedNumberValue) {
        this.elementPath = null;
        this.elementFrame = elementFrame;
        this.expectedNumberValue = expectedNumberValue;
    }

    public WebItemElementLabelNumberValueCondition<T> containsLabel() {
        return this;
    }

    public WebItemElementLabelNumberValueCondition<T> notContainLabel() {
        return this.inverse();
    }
    ...
    private WebItemElementLabelNumberValueCondition<T> inverse() {
        inverse = true;
        return this;
    }
