...
public class WebTableCellElementPropertyTextCondition implements WebTableRowCondition {
    ...
    public WebTableCellElementPropertyTextCondition(@NotNull String columnName,
    ...
    public WebTableCellElementPropertyTextCondition containsProperty() {
        return this;
    }
    ...
    private WebTableCellElementPropertyTextCondition inverse() {
        inverse = true;
        return this;
    }
