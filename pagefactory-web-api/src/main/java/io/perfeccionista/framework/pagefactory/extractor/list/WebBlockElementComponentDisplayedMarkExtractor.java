...
public class WebBlockElementComponentDisplayedMarkExtractor<T extends WebBlock> implements WebBlockValueExtractor<Boolean, T> {

    private final String elementPath;
    private final WebChildElement elementFrame;
    private final String componentName;

    public WebBlockElementComponentDisplayedMarkExtractor(@NotNull String elementPath,
    ...
    public WebBlockElementComponentDisplayedMarkExtractor(@NotNull WebComponentAvailable elementFrame,
                                                          @NotNull String componentName) {
