...
public class WebBlockElementTextNumberValueCondition<T extends WebBlock> implements WebBlockCondition<T> {
    ...
    public WebBlockElementTextNumberValueCondition(@NotNull String elementPath, @NotNull NumberValue<?> expectedNumberValue) {
        this.elementPath = elementPath;
        this.elementFrame = null;
        this.expectedNumberValue = expectedNumberValue;
    }

    public WebBlockElementTextNumberValueCondition(@NotNull WebGetTextAvailable elementFrame, @NotNull NumberValue<?> expectedNumberValue) {
        this.elementPath = null;
        this.elementFrame = elementFrame;
        this.expectedNumberValue = expectedNumberValue;
    }

    public WebBlockElementTextNumberValueCondition<T> containsText() {
        return this;
    }

    public WebBlockElementTextNumberValueCondition<T> notContainText() {
        return this.inverse();
    }
    ...
    private WebBlockElementTextNumberValueCondition<T> inverse() {
        inverse = true;
        return this;
    }
