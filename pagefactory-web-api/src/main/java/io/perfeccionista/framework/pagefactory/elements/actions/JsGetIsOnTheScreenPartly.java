...
public class JsGetIsOnTheScreenPartly implements WebElementJsOperationActionImplementation<Boolean> {
    ...
    public @NotNull JsOperation<Boolean> getJsOperation(@NotNull WebChildElementBase element, Object... args) {
        return JsOperation.of(element.getLocatorChainTo(ROOT), new GetIsOnTheScreen(false));
    }
