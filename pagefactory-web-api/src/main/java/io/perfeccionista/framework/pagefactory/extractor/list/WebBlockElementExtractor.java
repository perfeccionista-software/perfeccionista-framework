...
public class WebBlockElementExtractor<R extends WebChildElement, T extends WebBlock> implements WebBlockValueExtractor<R, T> {

    private final String elementPath;
    private final R elementFrame;
    private final Class<R> returnType;

    public WebBlockElementExtractor(@NotNull String elementPath, @NotNull Class<R> returnType) {
        this.elementPath = elementPath;
        this.elementFrame = null;
        this.returnType = returnType;
    }

    public WebBlockElementExtractor(@NotNull R elementFrame) {
