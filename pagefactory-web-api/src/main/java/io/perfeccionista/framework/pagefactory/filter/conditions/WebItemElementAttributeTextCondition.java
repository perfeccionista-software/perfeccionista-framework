...
public class WebItemElementAttributeTextCondition<T extends WebBlock<?>> implements WebItemCondition<T> {
    ...
    public WebItemElementAttributeTextCondition(@NotNull String elementPath,
    ...
    public WebItemElementAttributeTextCondition(@NotNull WebChildElement elementFrame,
                                                @NotNull String componentName,
                                                @NotNull String attributeName,
                                                @NotNull String expectedText) {
    ...
    public WebItemElementAttributeTextCondition<T> containsAttribute() {
        return this;
    }

    public WebItemElementAttributeTextCondition<T> notContainAttribute() {
        return this.inverse();
    }
    ...
    private WebItemElementAttributeTextCondition<T> inverse() {
        inverse = true;
        return this;
    }
