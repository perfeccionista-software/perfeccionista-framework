...
public class WebBlockElementTextCondition<T extends WebBlock> implements WebBlockCondition<T> {
    ...
    public WebBlockElementTextCondition(@NotNull String elementPath, @NotNull String expectedText) {
        this.elementPath = elementPath;
        this.elementFrame = null;
        this.expectedText = expectedText;
    }

    public WebBlockElementTextCondition(@NotNull WebGetTextAvailable elementFrame, @NotNull String expectedText) {
        this.elementPath = null;
        this.elementFrame = elementFrame;
        this.expectedText = expectedText;
    }

    public WebBlockElementTextCondition<T> containsText() {
        return this;
    }

    public WebBlockElementTextCondition<T> notContainText() {
        return this.inverse();
    }
    ...
    private WebBlockElementTextCondition<T> inverse() {
        inverse = true;
        return this;
    }
