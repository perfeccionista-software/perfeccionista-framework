...
public class WebTableCellElementComponentDisplayedMarkExtractor implements WebTableCellValueExtractor<Boolean> {
    ...
    public WebTableCellElementComponentDisplayedMarkExtractor(@NotNull String columnName,
