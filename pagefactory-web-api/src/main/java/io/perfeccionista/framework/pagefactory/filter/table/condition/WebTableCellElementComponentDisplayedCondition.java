...
public class WebTableCellElementComponentDisplayedCondition implements WebTableRowCondition {
    ...
    public WebTableCellElementComponentDisplayedCondition(@NotNull String columnName,
    ...
    public WebTableCellElementComponentDisplayedCondition componentDisplayed() {
        return this;
    }

    public WebTableCellElementComponentDisplayedCondition componentNotDisplayed() {
        return this.inverse();
    }
    ...
    private WebTableCellElementComponentDisplayedCondition inverse() {
        this.inverse = true;
        return this;
    }
