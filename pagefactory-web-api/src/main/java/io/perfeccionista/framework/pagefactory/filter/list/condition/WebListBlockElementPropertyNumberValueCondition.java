...
public class WebListBlockElementPropertyNumberValueCondition<T extends WebBlock> implements WebListBlockCondition<T> {
    ...
    public WebListBlockElementPropertyNumberValueCondition<T> containsProperty() {
        return this;
    }

    public WebListBlockElementPropertyNumberValueCondition<T> notContainProperty() {
        return this.inverse();
    }
    ...
    private WebListBlockElementPropertyNumberValueCondition<T> inverse() {
        inverse = true;
        return this;
    }
