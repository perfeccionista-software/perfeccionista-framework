...
public class WebItemElementTextCondition<T extends WebBlock<?>> implements WebItemCondition<T> {
    ...
    public WebItemElementTextCondition(@NotNull String elementPath, @NotNull String expectedText) {
        this.elementPath = elementPath;
        this.elementFrame = null;
        this.expectedText = expectedText;
    }

    public WebItemElementTextCondition(@NotNull WebGetTextAvailable elementFrame, @NotNull String expectedText) {
        this.elementPath = null;
        this.elementFrame = elementFrame;
        this.expectedText = expectedText;
    }

    public WebItemElementTextCondition<T> containsText() {
        return this;
    }

    public WebItemElementTextCondition<T> notContainText() {
        return this.inverse();
    }
    ...
    private WebItemElementTextCondition<T> inverse() {
        inverse = true;
        return this;
    }
