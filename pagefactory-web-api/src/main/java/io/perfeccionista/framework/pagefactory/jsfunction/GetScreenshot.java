...
import static io.perfeccionista.framework.exceptions.messages.PageFactoryWebApiMessages.SCREENSHOT_MIME_TYPE_NOT_SUPPORTED;
...
public class GetScreenshot implements JsFunction<Screenshot> {
    ...
    public String getScriptName() {
        return "perfeccionista.web.js.GetScreenshot";
    }
