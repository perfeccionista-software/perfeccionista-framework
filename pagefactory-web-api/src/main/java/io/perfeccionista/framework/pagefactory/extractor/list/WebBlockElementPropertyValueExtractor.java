...
public class WebBlockElementPropertyValueExtractor<T extends WebBlock> implements WebBlockValueExtractor<String, T> {

    private final String elementPath;
    private final WebChildElement elementFrame;
    private final String propertyName;

    public WebBlockElementPropertyValueExtractor(@NotNull String elementPath, @NotNull String propertyName) {
        this.elementPath = elementPath;
        this.elementFrame = null;
        this.propertyName = propertyName;
    }

    public WebBlockElementPropertyValueExtractor(@NotNull WebChildElement elementFrame, @NotNull String propertyName) {
