...
public class WebItemElementDisplayedCondition<T extends WebBlock<?>> implements WebItemCondition<T> {
    ...
    public WebItemElementDisplayedCondition(@NotNull String elementPath) {
        this.elementPath = elementPath;
        this.elementFrame = null;
    }

    public WebItemElementDisplayedCondition(@NotNull WebIsDisplayedAvailable elementFrame) {
        this.elementPath = null;
        this.elementFrame = (WebChildElement) elementFrame;
    }

    public WebItemElementDisplayedCondition<T> displayed() {
        return this;
    }

    public WebItemElementDisplayedCondition<T> notDisplayed() {
        return this.inverse();
    }
    ...
    private WebItemElementDisplayedCondition<T> inverse() {
        inverse = true;
        return this;
    }
