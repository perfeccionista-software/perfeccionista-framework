...
public class WebItemElementTextStringValueCondition<T extends WebBlock<?>> implements WebItemCondition<T> {
    ...
    public WebItemElementTextStringValueCondition(@NotNull String elementPath, @NotNull StringValue expectedStringValue) {
        this.elementPath = elementPath;
        this.elementFrame = null;
        this.expectedStringValue = expectedStringValue;
    }

    public WebItemElementTextStringValueCondition(@NotNull WebGetTextAvailable elementFrame, @NotNull StringValue expectedStringValue) {
        this.elementPath = null;
        this.elementFrame = elementFrame;
        this.expectedStringValue = expectedStringValue;
    }

    public WebItemElementTextStringValueCondition<T> containsText() {
        return this;
    }

    public WebItemElementTextStringValueCondition<T> notContainText() {
        return this.inverse();
    }
    ...
    private WebItemElementTextStringValueCondition<T> inverse() {
        inverse = true;
        return this;
    }
