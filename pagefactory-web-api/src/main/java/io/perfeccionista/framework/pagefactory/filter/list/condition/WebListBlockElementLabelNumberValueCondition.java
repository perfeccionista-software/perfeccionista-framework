...
public class WebListBlockElementLabelNumberValueCondition  implements WebListBlockCondition {
    ...
    public WebListBlockElementLabelNumberValueCondition(@NotNull GetLabelAvailable elementFrame, @NotNull NumberValue<?> expectedNumberValue) {
        this.elementPath = null;
        this.elementFrame = (WebChildElement) elementFrame;
        this.expectedNumberValue = expectedNumberValue;
    }

    public WebListBlockElementLabelNumberValueCondition containsLabel() {
        return this;
    }

    public WebListBlockElementLabelNumberValueCondition notContainsLabel() {
        return this.inverse();
    }
    ...
    private WebListBlockElementLabelNumberValueCondition inverse() {
        inverse = true;
        return this;
    }
