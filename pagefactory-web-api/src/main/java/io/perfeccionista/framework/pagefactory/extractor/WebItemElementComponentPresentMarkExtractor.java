...
public class WebItemElementComponentPresentMarkExtractor<T extends WebBlock<?>> implements WebItemValueExtractor<Boolean, T> {

    private final String elementPath;
    private final WebChildElement elementFrame;
    private final String componentName;

    public WebItemElementComponentPresentMarkExtractor(@NotNull String elementPath,
    ...
    public WebItemElementComponentPresentMarkExtractor(@NotNull WebChildElement elementFrame,
                                                       @NotNull String componentName) {
