...
public class WebSetValueOperationType implements WebElementOperationType<Void> {
    ...
    private WebSetValueOperationType(WebInputTextAvailable element, String text) {
    ...
    public static WebSetValueOperationType of(@NotNull WebInputTextAvailable element, @NotNull String text) {
        return new WebSetValueOperationType(element, text);
    }
