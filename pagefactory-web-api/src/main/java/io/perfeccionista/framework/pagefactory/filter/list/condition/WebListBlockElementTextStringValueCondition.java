...
public class WebListBlockElementTextStringValueCondition implements WebListBlockCondition {
    ...
    public WebListBlockElementTextStringValueCondition(@NotNull GetTextAvailable elementFrame, @NotNull StringValue expectedStringValue) {
    ...
    public WebListBlockElementTextStringValueCondition notContainsText() {
        return this.inverse();
    }
