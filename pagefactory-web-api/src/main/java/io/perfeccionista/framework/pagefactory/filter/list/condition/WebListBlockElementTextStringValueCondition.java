...
public class WebListBlockElementTextStringValueCondition<T extends WebBlock> implements WebListBlockCondition<T> {
    ...
    public WebListBlockElementTextStringValueCondition(@NotNull String elementPath, @NotNull StringValue expectedStringValue) {
        this.elementPath = elementPath;
        this.elementFrame = null;
        this.expectedStringValue = expectedStringValue;
    }

    public WebListBlockElementTextStringValueCondition(@NotNull WebGetTextAvailable elementFrame, @NotNull StringValue expectedStringValue) {
        this.elementPath = null;
        this.elementFrame = elementFrame;
        this.expectedStringValue = expectedStringValue;
    }

    public WebListBlockElementTextStringValueCondition<T> containsText() {
        return this;
    }

    public WebListBlockElementTextStringValueCondition<T> notContainText() {
        return this.inverse();
    }
    ...
    private WebListBlockElementTextStringValueCondition<T> inverse() {
        inverse = true;
        return this;
    }
