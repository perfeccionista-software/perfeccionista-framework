...
public class JsGetTextFromTitle implements WebElementJsOperationActionImplementation<String> {
    ...
    public @NotNull JsOperation<String> getJsOperation(@NotNull WebChildElementBase element, Object... args) {
        return JsOperation.of(element.getLocatorChainTo(TEXT), new GetAttribute("title"));
    }
