...
import io.perfeccionista.framework.pagefactory.jsfunction.GetIsOnTheScreen;
...
public class JsGetIsOnTheScreenCompletely implements WebElementJsOperationActionImplementation<Boolean> {
    ...
    public @NotNull JsOperation<Boolean> getJsOperation(@NotNull WebChildElementBase element, Object... args) {
        return JsOperation.of(element.getLocatorChainTo(ROOT), new GetIsOnTheScreen(true));
    }
