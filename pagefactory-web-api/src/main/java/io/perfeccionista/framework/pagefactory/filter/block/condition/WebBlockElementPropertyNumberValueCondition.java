...
public class WebBlockElementPropertyNumberValueCondition<T extends WebBlock> implements WebBlockCondition<T> {
    ...
    public WebBlockElementPropertyNumberValueCondition(@NotNull String elementPath,
    ...
    public WebBlockElementPropertyNumberValueCondition(@NotNull WebChildElement elementFrame,
                                                       @NotNull String propertyName,
                                                       @NotNull NumberValue<? extends Number> expectedNumberValue) {
    ...
    public WebBlockElementPropertyNumberValueCondition<T> containsProperty() {
        return this;
    }

    public WebBlockElementPropertyNumberValueCondition<T> notContainProperty() {
        return this.inverse();
    }
    ...
    private WebBlockElementPropertyNumberValueCondition<T> inverse() {
        inverse = true;
        return this;
    }
