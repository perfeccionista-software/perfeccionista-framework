...
public class WebBlockElementLabelTextCondition<T extends WebBlock> implements WebBlockCondition<T> {
    ...
    public WebBlockElementLabelTextCondition(@NotNull String elementPath, @NotNull String expectedText) {
        this.elementPath = elementPath;
        this.elementFrame = null;
        this.expectedText = expectedText;
    }

    public WebBlockElementLabelTextCondition(@NotNull WebGetLabelAvailable elementFrame, @NotNull String expectedText) {
        this.elementPath = null;
        this.elementFrame = elementFrame;
        this.expectedText = expectedText;
    }

    public WebBlockElementLabelTextCondition<T> containsLabel() {
        return this;
    }

    public WebBlockElementLabelTextCondition<T> notContainLabel() {
        return this.inverse();
    }
    ...
    private WebBlockElementLabelTextCondition<T> inverse() {
        inverse = true;
        return this;
    }
