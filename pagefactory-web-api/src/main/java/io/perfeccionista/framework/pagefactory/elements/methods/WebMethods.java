...
public class WebMethods extends AvailableElementMethods {
    ...
    public static final String SHOULD_HAVE_LOCATION_METHOD = "ShouldHaveLocation";
    public static final String SHOULD_NOT_HAVE_LOCATION_METHOD = "ShouldNotHaveLocation";
