...
public class WebTextBlockTextCondition implements WebTextBlockCondition {
    ...
    public WebTextBlockTextCondition(@NotNull String expectedText) {
        this.expectedText = expectedText;
    }

    public WebTextBlockTextCondition containsTextBlock() {
        return this;
    }

    public WebTextBlockTextCondition notContainTextBlock() {
        return this.inverse();
    }

    @Override
    public WebTextBlockTextCondition and(@NotNull WebTextBlockCondition condition) {
        childConditions.add(WebTextListBlockConditionHolder.of(AND, condition));
        return this;
    }

    @Override
    public WebTextBlockTextCondition or(@NotNull WebTextBlockCondition condition) {
    ...
    private WebTextBlockTextCondition inverse() {
        inverse = true;
        return this;
    }
