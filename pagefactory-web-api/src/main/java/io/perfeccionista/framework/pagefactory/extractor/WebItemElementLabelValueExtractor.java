...
public class WebItemElementLabelValueExtractor<T extends WebBlock<?>> implements WebItemValueExtractor<String, T> {

    private final String elementPath;
    private final WebGetTextAvailable elementFrame;

    public WebItemElementLabelValueExtractor(@NotNull String elementPath) {
        this.elementPath = elementPath;
        this.elementFrame = null;
    }

    public WebItemElementLabelValueExtractor(@NotNull WebGetTextAvailable elementFrame) {
