...
public class WebBlockElementComponentDisplayedCondition<T extends WebBlock> implements WebBlockCondition<T> {
    ...
    public WebBlockElementComponentDisplayedCondition(@NotNull String elementPath, @NotNull String componentName) {
        this.elementPath = elementPath;
        this.elementFrame = null;
        this.componentName = componentName;
    }

    public WebBlockElementComponentDisplayedCondition(@NotNull WebChildElement elementFrame, @NotNull String componentName) {
        this.elementPath = null;
        this.elementFrame = elementFrame;
        this.componentName = componentName;
    }

    public WebBlockElementComponentDisplayedCondition<T> componentDisplayed() {
        return this;
    }

    public WebBlockElementComponentDisplayedCondition<T> componentNotDisplayed() {
        return this.inverse();
    }
    ...
    private WebBlockElementComponentDisplayedCondition<T> inverse() {
        inverse = true;
        return this;
    }
