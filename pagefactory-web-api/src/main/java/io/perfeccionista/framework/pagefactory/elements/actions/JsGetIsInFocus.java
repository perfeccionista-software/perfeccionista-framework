...
public class JsGetIsInFocus implements WebElementJsOperationActionImplementation<Boolean> {
    ...
    public @NotNull JsOperation<Boolean> getJsOperation(@NotNull WebChildElementBase element, Object... args) {
        return JsOperation.of(element.getLocatorChainTo(FOCUS), new GetIsInFocus());
    }
