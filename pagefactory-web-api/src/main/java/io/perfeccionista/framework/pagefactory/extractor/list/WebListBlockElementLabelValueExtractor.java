...
public class WebListBlockElementLabelValueExtractor implements WebListBlockValueExtractor<String> {
    ...
    public WebListBlockElementLabelValueExtractor(@NotNull String elementPath) {
        this.elementPath = elementPath;
        this.elementFrame = null;
    }

    public WebListBlockElementLabelValueExtractor(@NotNull WebGetLabelAvailable elementFrame) {
