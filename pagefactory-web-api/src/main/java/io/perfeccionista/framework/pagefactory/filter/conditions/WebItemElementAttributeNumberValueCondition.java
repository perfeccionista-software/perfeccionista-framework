...
public class WebItemElementAttributeNumberValueCondition<T extends WebBlock<?>> implements WebItemCondition<T> {
    ...
    public WebItemElementAttributeNumberValueCondition(@NotNull String elementPath,
    ...
    public WebItemElementAttributeNumberValueCondition(@NotNull WebChildElement elementFrame,
                                                       @NotNull String componentName,
                                                       @NotNull String attributeName,
                                                       @NotNull NumberValue<? extends Number> expectedNumberValue) {
    ...
    public WebItemElementAttributeNumberValueCondition<T> containsAttribute() {
        return this;
    }

    public WebItemElementAttributeNumberValueCondition<T> notContainAttribute() {
        return this.inverse();
    }
    ...
    private WebItemElementAttributeNumberValueCondition<T> inverse() {
        inverse = true;
        return this;
    }
