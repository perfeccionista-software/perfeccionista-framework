...
public class WebTableCellElementTextCondition implements WebTableRowCondition {
    ...
    public WebTableCellElementTextCondition(@NotNull String columnName,
    ...
    public WebTableCellElementTextCondition containsText() {
        return this;
    }

    public WebTableCellElementTextCondition notContainsText() {
        return this.inverse();
    }
    ...
    private WebTableCellElementTextCondition inverse() {
        inverse = true;
        return this;
    }
