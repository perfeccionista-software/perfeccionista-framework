...
public class IsDisplayedStateExtractor implements WebElementStateExtractor {
    ...
    public WebElementOperation<Boolean> getOperation(@NotNull WebChildElement element, Optional<WebSelectorHolder> locatorHolder) {
        ...
        return WebElementOperation.of(locatorChain, WebGetIsDisplayedOperationType.of(element, DISPLAYED));
    }
