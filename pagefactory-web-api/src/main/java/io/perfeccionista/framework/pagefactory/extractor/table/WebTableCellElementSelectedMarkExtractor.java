...
public class WebTableCellElementSelectedMarkExtractor implements WebTableValueExtractor<Boolean> {
    ...
    public WebTableCellElementSelectedMarkExtractor(@NotNull String columnName, @NotNull String elementPath) {
        this.columnName = columnName;
        this.elementPath = elementPath;
        this.elementFrame = null;
    }

    public WebTableCellElementSelectedMarkExtractor(@NotNull String columnName, @NotNull IsSelectedAvailable elementFrame) {
        this.columnName = columnName;
    ...
    @Override
    public WebTableCellElementSelectedMarkExtractor fromHeader() {
        this.section = TableSection.HEADER;
        return this;
    }

    @Override
    public WebTableCellElementSelectedMarkExtractor fromFooter() {
