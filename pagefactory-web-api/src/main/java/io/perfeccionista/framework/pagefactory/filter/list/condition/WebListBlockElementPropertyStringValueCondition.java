...
public class WebListBlockElementPropertyStringValueCondition<T extends WebBlock> implements WebListBlockCondition<T> {
    ...
    public WebListBlockElementPropertyStringValueCondition(@NotNull String elementPath,
    ...
    public WebListBlockElementPropertyStringValueCondition(@NotNull WebChildElement elementFrame,
                                                           @NotNull String propertyName,
                                                           @NotNull StringValue expectedStringValue) {
    ...
    public WebListBlockElementPropertyStringValueCondition<T> containsProperty() {
        return this;
    }

    public WebListBlockElementPropertyStringValueCondition<T> notContainProperty() {
        return this.inverse();
    }
    ...
    private WebListBlockElementPropertyStringValueCondition<T> inverse() {
        inverse = true;
        return this;
    }
