...
public class WebTableCellElementLabelStringValueCondition implements WebTableRowCondition {
    ...
    public WebTableCellElementLabelStringValueCondition(@NotNull String columnName,
    ...
    public WebTableCellElementLabelStringValueCondition containsLabel() {
        return this;
    }

    public WebTableCellElementLabelStringValueCondition notContainsLabel() {
        return this.inverse();
    }
    ...
    private WebTableCellElementLabelStringValueCondition inverse() {
        inverse = true;
        return this;
    }
