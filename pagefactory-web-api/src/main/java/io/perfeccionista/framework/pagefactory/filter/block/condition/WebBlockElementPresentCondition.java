...
public class WebBlockElementPresentCondition<T extends WebBlock> implements WebBlockCondition<T> {
    ...
    public WebBlockElementPresentCondition(@NotNull String elementPath) {
        this.elementPath = elementPath;
        this.elementFrame = null;
    }

    public WebBlockElementPresentCondition(@NotNull WebIsPresentAvailable elementFrame) {
        this.elementPath = null;
        this.elementFrame = (WebChildElement) elementFrame;
    }

    public WebBlockElementPresentCondition<T> present() {
        return this;
    }

    public WebBlockElementPresentCondition<T> notPresent() {
        return this.inverse();
    }
    ...
    private WebBlockElementPresentCondition<T> inverse() {
        inverse = true;
        return this;
    }
