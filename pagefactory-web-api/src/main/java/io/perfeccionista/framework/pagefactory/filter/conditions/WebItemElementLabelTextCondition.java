...
public class WebItemElementLabelTextCondition<T extends WebBlock<?>> implements WebItemCondition<T> {
    ...
    public WebItemElementLabelTextCondition(@NotNull String elementPath, @NotNull String expectedText) {
        this.elementPath = elementPath;
        this.elementFrame = null;
        this.expectedText = expectedText;
    }

    public WebItemElementLabelTextCondition(@NotNull WebGetTextAvailable elementFrame, @NotNull String expectedText) {
        this.elementPath = null;
        this.elementFrame = elementFrame;
        this.expectedText = expectedText;
    }

    public WebItemElementLabelTextCondition<T> containsLabel() {
        return this;
    }

    public WebItemElementLabelTextCondition<T> notContainLabel() {
        return this.inverse();
    }
    ...
    private WebItemElementLabelTextCondition<T> inverse() {
        inverse = true;
        return this;
    }
