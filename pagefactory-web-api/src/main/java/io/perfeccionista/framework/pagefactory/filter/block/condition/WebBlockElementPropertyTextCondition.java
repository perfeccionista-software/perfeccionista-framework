...
public class WebBlockElementPropertyTextCondition<T extends WebBlock> implements WebBlockCondition<T> {
    ...
    public WebBlockElementPropertyTextCondition(@NotNull String elementPath,
    ...
    public WebBlockElementPropertyTextCondition(@NotNull WebChildElement elementFrame,
                                                @NotNull String propertyName,
                                                @NotNull String expectedText) {
    ...
    public WebBlockElementPropertyTextCondition<T> containsProperty() {
        return this;
    }

    public WebBlockElementPropertyTextCondition<T> notContainProperty() {
        return this.inverse();
    }
    ...
    private WebBlockElementPropertyTextCondition<T> inverse() {
        inverse = true;
        return this;
    }
