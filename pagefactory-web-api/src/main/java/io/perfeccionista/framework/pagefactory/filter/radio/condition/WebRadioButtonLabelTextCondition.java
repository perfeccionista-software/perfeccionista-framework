...
public class WebRadioButtonLabelTextCondition implements WebRadioButtonCondition {
    ...
    public WebRadioButtonLabelTextCondition(@NotNull String expectedText) {
        this.expectedText = expectedText;
    }

    public WebRadioButtonLabelTextCondition containsLabel() {
        return this;
    }

    public WebRadioButtonLabelTextCondition notContainLabel() {
        return this.inverse();
    }
    ...
    private WebRadioButtonLabelTextCondition inverse() {
        inverse = true;
        return this;
    }
