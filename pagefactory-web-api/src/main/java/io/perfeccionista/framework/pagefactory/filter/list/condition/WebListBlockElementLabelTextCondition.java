...
public class WebListBlockElementLabelTextCondition<T extends WebBlock> implements WebListBlockCondition<T> {
    ...
    public WebListBlockElementLabelTextCondition(@NotNull WebGetLabelAvailable elementFrame, @NotNull String expectedText) {
        this.elementPath = null;
        this.elementFrame = elementFrame;
        this.expectedText = expectedText;
    }

    public WebListBlockElementLabelTextCondition<T> containsLabel() {
        return this;
    }

    public WebListBlockElementLabelTextCondition<T> notContainLabel() {
        return this.inverse();
    }
    ...
    private WebListBlockElementLabelTextCondition<T> inverse() {
        inverse = true;
        return this;
    }
