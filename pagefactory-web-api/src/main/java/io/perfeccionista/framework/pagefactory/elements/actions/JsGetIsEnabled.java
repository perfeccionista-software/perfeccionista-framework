...
import io.perfeccionista.framework.pagefactory.jsfunction.GetIsEnabled;
...
public class JsGetIsEnabled implements WebElementJsOperationActionImplementation<Boolean> {
    ...
    public @NotNull JsOperation<Boolean> getJsOperation(@NotNull WebChildElementBase element, Object... args) {
        return JsOperation.of(element.getLocatorChainTo(ENABLED), new GetIsEnabled());
    }
