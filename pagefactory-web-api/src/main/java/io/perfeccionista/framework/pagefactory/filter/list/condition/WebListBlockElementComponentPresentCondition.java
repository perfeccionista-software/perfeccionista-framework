...
public class WebListBlockElementComponentPresentCondition<T extends WebBlock> implements WebListBlockCondition<T> {
    ...
    public WebListBlockElementComponentPresentCondition<T> componentPresent() {
        return this;
    }

    public WebListBlockElementComponentPresentCondition<T> componentNotPresent() {
        return this.inverse();
    }
    ...
    private WebListBlockElementComponentPresentCondition<T> inverse() {
        inverse = true;
        return this;
    }
