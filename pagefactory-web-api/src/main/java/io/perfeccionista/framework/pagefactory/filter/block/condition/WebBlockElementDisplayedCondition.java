...
public class WebBlockElementDisplayedCondition<T extends WebBlock> implements WebBlockCondition<T> {
    ...
    public WebBlockElementDisplayedCondition(@NotNull String elementPath) {
        this.elementPath = elementPath;
        this.elementFrame = null;
    }

    public WebBlockElementDisplayedCondition(@NotNull WebIsDisplayedAvailable elementFrame) {
        this.elementPath = null;
        this.elementFrame = (WebChildElement) elementFrame;
    }

    public WebBlockElementDisplayedCondition<T> displayed() {
        return this;
    }

    public WebBlockElementDisplayedCondition<T> notDisplayed() {
        return this.inverse();
    }
    ...
    private WebBlockElementDisplayedCondition<T> inverse() {
        inverse = true;
        return this;
    }
