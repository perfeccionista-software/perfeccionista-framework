...
public class WebBlockElementLabelNumberValueCondition<T extends WebBlock>  implements WebBlockCondition<T> {
    ...
    public WebBlockElementLabelNumberValueCondition(@NotNull String elementPath, @NotNull NumberValue<?> expectedNumberValue) {
        this.elementPath = elementPath;
        this.elementFrame = null;
        this.expectedNumberValue = expectedNumberValue;
    }

    public WebBlockElementLabelNumberValueCondition(@NotNull WebGetLabelAvailable elementFrame, @NotNull NumberValue<?> expectedNumberValue) {
        this.elementPath = null;
        this.elementFrame = elementFrame;
        this.expectedNumberValue = expectedNumberValue;
    }

    public WebBlockElementLabelNumberValueCondition<T> containsLabel() {
        return this;
    }

    public WebBlockElementLabelNumberValueCondition<T> notContainLabel() {
        return this.inverse();
    }
    ...
    private WebBlockElementLabelNumberValueCondition<T> inverse() {
        inverse = true;
        return this;
    }
