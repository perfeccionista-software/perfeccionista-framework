...
public class WebBlockElementPropertyStringValueCondition<T extends WebBlock> implements WebBlockCondition<T> {
    ...
    public WebBlockElementPropertyStringValueCondition(@NotNull String elementPath,
    ...
    public WebBlockElementPropertyStringValueCondition(@NotNull WebChildElement elementFrame,
                                                       @NotNull String propertyName,
                                                       @NotNull StringValue expectedStringValue) {
    ...
    public WebBlockElementPropertyStringValueCondition<T> containsProperty() {
        return this;
    }

    public WebBlockElementPropertyStringValueCondition<T> notContainProperty() {
        return this.inverse();
    }
    ...
    private WebBlockElementPropertyStringValueCondition<T> inverse() {
        inverse = true;
        return this;
    }
