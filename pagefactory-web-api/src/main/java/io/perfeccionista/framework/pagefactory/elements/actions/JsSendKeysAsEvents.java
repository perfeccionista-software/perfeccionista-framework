...
import io.perfeccionista.framework.pagefactory.jsfunction.SendKeysAsEvents;
 ...
 */
@Deprecated
public class JsSendKeysAsEvents implements WebElementJsOperationActionImplementation<Void> {
    ...
    public @NotNull JsOperation<Void> getJsOperation(@NotNull WebChildElementBase element, Object... args) {
        ...
        return JsOperation.of(locatorChain, new SendKeysAsEvents(keysEventChain));
    }
