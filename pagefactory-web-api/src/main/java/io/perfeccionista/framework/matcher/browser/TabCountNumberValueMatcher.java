...
import static io.perfeccionista.framework.pagefactory.browser.WebBrowserActionNames.BROWSER_SHOULD_HAVE_TABS_COUNT_NUMBER_VALUE_METHOD;
import static io.perfeccionista.framework.pagefactory.browser.WebBrowserActionNames.BROWSER_SHOULD_NOT_HAVE_TABS_COUNT_NUMBER_VALUE_METHOD;

public class TabCountNumberValueMatcher implements TabsDispatcherMatcher {

    protected final NumberValue<Integer> expectedNumberValue;
    protected final boolean positive;

    public TabCountNumberValueMatcher(NumberValue<Integer> expectedNumberValue, boolean positive) {
