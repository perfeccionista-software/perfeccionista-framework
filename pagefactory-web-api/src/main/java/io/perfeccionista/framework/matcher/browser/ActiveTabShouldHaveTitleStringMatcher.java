...
import static io.perfeccionista.framework.pagefactory.browser.WebBrowserActionNames.ACTIVE_TAB_SHOULD_HAVE_TITLE_METHOD;
import static io.perfeccionista.framework.pagefactory.browser.WebBrowserActionNames.ACTIVE_TAB_SHOULD_NOT_HAVE_TITLE_METHOD;

public class ActiveTabShouldHaveTitleStringMatcher implements TabsDispatcherMatcher {

    protected final String expectedText;
    protected final boolean positive;

    public ActiveTabShouldHaveTitleStringMatcher(String expectedText, boolean positive) {
