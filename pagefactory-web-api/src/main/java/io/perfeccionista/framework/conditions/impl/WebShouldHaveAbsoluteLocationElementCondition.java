...
public class WebShouldHaveAbsoluteLocationElementCondition implements WebElementCondition {

    private String componentName;
    private final Point2D expectedLocation;
    private boolean positive;

    public WebShouldHaveAbsoluteLocationElementCondition(@NotNull Point2D expectedLocation) {
    ...
    @Override
    public WebShouldHaveAbsoluteLocationElementCondition validate(@NotNull WebChildElement element) {
        // WebChildElement extends WebGetElementBoundsAvailable interface
        return this;
    }

    @Override
    public WebShouldHaveAbsoluteLocationElementCondition forComponent(@NotNull String componentName) {
        this.componentName = componentName;
        return this;
    }

    @Override
    public WebShouldHaveAbsoluteLocationElementCondition inverse() {
        this.positive = !positive;
        return this;
    }

    protected void shouldHaveLocation(WebChildElement element, Point2D actualLocation, Point2D expectedLocation, String componentName) {
    ...
    protected void shouldNotHaveLocation(WebChildElement element, Point2D actualLocation, Point2D expectedLocation, String componentName) {
        if (expectedLocation.equals(actualLocation)) {
