...
public class Location2D {
    ...
    private Location2D(Double pageX,
                       Double pageY,
    ...
    public static Location2D of(double pageX,
                                double pageY,
                                double absolutePageX,
                                double absolutePageY,
                                double elementCenterX,
                                double elementCenterY) {
        return new Location2D(pageX, pageY, absolutePageX, absolutePageY, elementCenterX, elementCenterY);
    }

    public static Location2D relative(double pageX, double pageY) {
        return new Location2D(pageX, pageY, null, null, null, null);
    }

    public static Location2D absolute(double absolutePageX, double absolutePageY) {
        return new Location2D(null, null, absolutePageX, absolutePageY, null, null);
    }

    public static Location2D center(double elementCenterX, double elementCenterY) {
        return new Location2D(null, null, null, null, elementCenterX, elementCenterY);
    }
    ...
    public Location2D setInaccuracy(double inaccuracy) {
        this.inaccuracy = Math.abs(inaccuracy);
        return this;
    }

    public Location2D offset(double x, double y) {
        ...
        return new Location2D(newPageX, newPageY, newAbsolutePageX, newAbsolutePageY, newElementCenterX, newElementCenterY);
    }
    ...
    public boolean equals(Object other) {
        ...
        Location2D that = (Location2D) other;
        if (inaccuracy == null) {
