...
public class DefaultAttachmentProcessor implements AttachmentProcessor {
    ...
    protected static final String BUILD_SYSTEM = "perfeccionista.build.system";
    ...
    protected String getAttachmentDir(){
        ...
        if (systemProperties.containsKey(BUILD_SYSTEM)) {
            if (systemProperties.getProperty(BUILD_SYSTEM).equals("maven")){
                return "target/attachments";
            } else if (systemProperties.getProperty(BUILD_SYSTEM).equals("gradle")){
                return "build/attachments";
            }
        }

        if (perfeccionistaProperties.containsKey(BUILD_SYSTEM)) {
            if (perfeccionistaProperties.getProperty(BUILD_SYSTEM).equals("maven")){
                return "target/attachments";
            } else if (perfeccionistaProperties.getProperty(BUILD_SYSTEM).equals("gradle")){
                return "build/attachments";
            }
        }
