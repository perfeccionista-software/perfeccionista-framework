...
@CucumberResolverExpression("in column {columnName} {webElement} is enabled")
@CucumberResolverExpression("в столбце {columnName} {webElement} доступен")
public class WebTableCellElementEnabledConditionCucumberResolver extends AbstractWebTableRowConditionCucumberResolver {
    ...
    public Optional<WebTableRowCondition> tryResolve(@NotNull String expression, @Nullable Object... args) {
        for (Pattern pattern : patterns) {
            ...
            if (matcher.find()) {
                ...
                return Optional.of(enabled(columnName, elementPath));
            }
        }
        return Optional.empty();
    }
