...
@CucumberResolverExpression("in column {columnName} {webElement} does not contain number {numberValue}")
@CucumberResolverExpression("в столбце {columnName} {webElement} не содержит число {numberValue}")
public class WebTableCellElementTextNumberValueNegativeConditionCucumberResolver  extends AbstractWebTableRowConditionCucumberResolver {
        ...
        for (Pattern pattern : patterns) {
            ...
            if (matcher.find()) {
                ...
                if (numberValue.contains(".")) {
                    ...
                    return Optional.of(notContainText(columnName, elementPath, resolvedNumberValue));
                }
