...
public class WebBlockElementComponentPresentMarkToStringExtractor implements WebBlockValueExtractor<String, WebBlock> {

    private final String elementPath;
    private final String componentName;

    public WebBlockElementComponentPresentMarkToStringExtractor(@NotNull String elementPath,
