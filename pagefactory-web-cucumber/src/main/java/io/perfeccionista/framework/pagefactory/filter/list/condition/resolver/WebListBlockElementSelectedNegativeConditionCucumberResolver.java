...
@CucumberResolverExpression("{webElement} is not selected")
@CucumberResolverExpression("{webElement} не выделен")
public class WebListBlockElementSelectedNegativeConditionCucumberResolver extends AbstractWebListBlockConditionCucumberResolver {
    ...
    public Optional<WebListBlockCondition> tryResolve(@NotNull String expression, @Nullable Object[] args) {
        for (Pattern pattern : patterns) {
            ...
            if (matcher.find()) {
                ...
                return Optional.of(notSelected(elementPath));
            }
        }
        return Optional.empty();
    }
