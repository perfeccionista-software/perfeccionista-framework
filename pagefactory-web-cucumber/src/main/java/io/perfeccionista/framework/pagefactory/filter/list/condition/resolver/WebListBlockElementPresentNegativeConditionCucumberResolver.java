...
@CucumberResolverExpression("{webElement} is not present")
@CucumberResolverExpression("{webElement} отсутствует")
public class WebListBlockElementPresentNegativeConditionCucumberResolver extends AbstractWebListBlockConditionCucumberResolver {
    ...
    public Optional<WebItemCondition> tryResolve(@NotNull String expression, @Nullable Object[] args) {
        for (Pattern pattern : patterns) {
            ...
            if (matcher.find()) {
                ...
                return Optional.of(notPresent(elementPath));
            }
        }
        return Optional.empty();
    }
