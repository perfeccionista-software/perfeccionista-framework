...
@CucumberResolverExpression("in column {columnName} number is not {numberValue}")
@CucumberResolverExpression("в столбце {columnName} не содержится число {numberValue}")
public class WebTextTableRowTextNumberValueNegativeConditionCucumberResolver extends AbstractWebTextTableRowConditionCucumberResolver {
        ...
        for (Pattern pattern : patterns) {
            ...
            if (matcher.find()) {
                ...
                if (numberValue.contains(".")) {
                    ...
                    return Optional.of(notContainTextCell(columnName, resolvedNumberValue));
                }
