...
@CucumberResolverExpression("{webElement} contains {stringValue}")
@CucumberResolverExpression("{webElement} содержит {stringValue}")
public class WebListBlockElementTextStringValueConditionCucumberResolver extends AbstractWebListBlockConditionCucumberResolver {
    ...
    public Optional<WebBlockCondition> tryResolve(@NotNull String expression, @Nullable Object[] args) {
        for (Pattern pattern : patterns) {
            ...
            if (matcher.find()) {
                ...
                return Optional.of(containsText(elementPath, resolvedStringValue));
            }
        }
        return Optional.empty();
    }
