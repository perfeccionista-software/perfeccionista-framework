...
@CucumberResolverExpression("{webElement} contains number {numberValue}")
@CucumberResolverExpression("{webElement} содержит число {numberValue}")
public class WebListBlockElementTextNumberValueConditionCucumberResolver extends AbstractWebListBlockConditionCucumberResolver {
        ...
        for (Pattern pattern : patterns) {
            ...
            if (matcher.find()) {
                ...
                if (numberValue.contains(".")) {
                    ...
                    return Optional.of(containsText(elementPath, resolvedNumberValue));
                }
