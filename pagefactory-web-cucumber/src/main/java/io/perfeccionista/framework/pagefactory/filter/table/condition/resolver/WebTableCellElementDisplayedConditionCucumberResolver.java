...
@CucumberResolverExpression("in column {columnName} {webElement} is displayed")
@CucumberResolverExpression("в столбце {columnName} {webElement} отображается")
public class WebTableCellElementDisplayedConditionCucumberResolver extends AbstractWebTableRowConditionCucumberResolver {
    ...
    public Optional<WebTableRowCondition> tryResolve(@NotNull String expression, @Nullable Object... args) {
        for (Pattern pattern : patterns) {
            ...
            if (matcher.find()) {
                ...
                return Optional.of(displayed(columnName, elementPath));
            }
        }
        return Optional.empty();
    }
