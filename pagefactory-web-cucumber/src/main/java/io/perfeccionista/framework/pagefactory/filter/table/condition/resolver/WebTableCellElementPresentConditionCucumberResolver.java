...
@CucumberResolverExpression("in column {columnName} {webElement} is present")
@CucumberResolverExpression("в столбце {columnName} {webElement} присутствует")
public class WebTableCellElementPresentConditionCucumberResolver extends AbstractWebTableRowConditionCucumberResolver {
    ...
    public Optional<WebTableRowCondition> tryResolve(@NotNull String expression, @Nullable Object... args) {
        for (Pattern pattern : patterns) {
            ...
            if (matcher.find()) {
                ...
                return Optional.of(present(columnName, elementPath));
            }
        }
        return Optional.empty();
    }
