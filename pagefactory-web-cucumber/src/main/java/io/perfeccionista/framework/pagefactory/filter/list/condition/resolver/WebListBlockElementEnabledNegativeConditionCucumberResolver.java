...
@CucumberResolverExpression("{webElement} is disabled")
@CucumberResolverExpression("{webElement} недоступен")
public class WebListBlockElementEnabledNegativeConditionCucumberResolver extends AbstractWebListBlockConditionCucumberResolver {
    ...
    public Optional<WebItemCondition> tryResolve(@NotNull String expression, @Nullable Object[] args) {
        for (Pattern pattern : patterns) {
            ...
            if (matcher.find()) {
                ...
                return Optional.of(disabled(elementPath));
            }
        }
        return Optional.empty();
    }
