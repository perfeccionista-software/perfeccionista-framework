...
import io.perfeccionista.framework.pagefactory.extractor.table.creator.WebTableCellElementPropertyValueExtractorCreator;
...
public class WebTableCellElementPropertyValueExtractorCucumberResolver extends AbstractWebTableValueExtractorCucumberResolver {
    ...
    public Optional<WebTableValueExtractorCreator> tryResolve(@NotNull String expression, @Nullable Object... args) {
        for (Pattern pattern : patterns) {
            ...
            if (matcher.find()) {
                ...
                return Optional.of(new WebTableCellElementPropertyValueExtractorCreator(propertyName));
            }
        }
        return Optional.empty();
    }
