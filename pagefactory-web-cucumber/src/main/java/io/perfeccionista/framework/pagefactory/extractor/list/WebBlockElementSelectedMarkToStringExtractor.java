...
public class WebBlockElementSelectedMarkToStringExtractor implements WebBlockValueExtractor<String, WebBlock> {

    private final String elementName;

    public WebBlockElementSelectedMarkToStringExtractor(String elementName) {
        this.elementName = elementName;
    }

    @Override
    public Map<Integer, String> extractValues(@NotNull WebBlockFilter<WebBlock> filter) {
        return new WebBlockElementSelectedMarkExtractor<>(elementName)
