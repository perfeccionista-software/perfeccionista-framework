...
@CucumberResolverExpression("в столбце {columnName} {webElement} выделен")
public class WebTableCellElementSelectedConditionCucumberResolver extends AbstractWebTableRowConditionCucumberResolver {
    ...
    public Optional<WebTableRowCondition> tryResolve(@NotNull String expression, @Nullable Object... args) {
        for (Pattern pattern : patterns) {
            ...
            if (matcher.find()) {
                ...
                return Optional.of(selected(columnName, elementPath));
            }
        }
        return Optional.empty();
    }
