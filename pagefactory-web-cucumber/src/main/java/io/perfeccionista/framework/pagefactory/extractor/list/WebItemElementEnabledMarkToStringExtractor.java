...
public class WebItemElementEnabledMarkToStringExtractor
//        implements WebItemValueExtractor<String, WebBlock>
{

    private final String elementName;

    public WebItemElementEnabledMarkToStringExtractor(String elementName) {
        this.elementName = elementName;
    }

//    @Override
//    public Map<Integer, String> extractValues(@NotNull WebBlockFilter<WebBlock> filter) {
//        return new WebItemElementEnabledMarkExtractor<>(elementName)
