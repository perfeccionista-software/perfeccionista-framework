...
import io.perfeccionista.framework.pagefactory.extractor.table.creator.WebTableCellElementComponentPresentMarkToStringExtractorCreator;
...
public class WebTableCellElementComponentPresentMarkToStringExtractorCucumberResolver extends AbstractWebTableValueExtractorCucumberResolver {
    ...
    public Optional<WebTableValueExtractorCreator> tryResolve(@NotNull String expression, @Nullable Object... args) {
        for (Pattern pattern : patterns) {
            ...
            if (matcher.find()) {
                ...
                return Optional.of(new WebTableCellElementComponentPresentMarkToStringExtractorCreator(component));
            }
        }
        return Optional.empty();
    }
