...
import io.perfeccionista.framework.pagefactory.elements.MobileRadioButton;
...
//@ElementAction(name = IS_SELECTED_METHOD, implementation = AppiumIsSelected.class)
//@ElementAction(name = TAP_METHOD, implementation = AppiumTap.class)
public abstract class MobileRadioButtonImpl extends AbstractMobileChildElement implements MobileRadioButton {
