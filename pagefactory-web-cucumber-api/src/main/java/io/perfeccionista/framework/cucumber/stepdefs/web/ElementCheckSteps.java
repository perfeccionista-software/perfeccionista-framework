...
public class ElementCheckSteps implements WebStepDefinitions {
     ...
     * @param elementFinder -
     */
    @Given("{webElement} is not present")
     ...
     * @param expectedText -
     */
    @Given("label of the {webElement} contains {stringValue}")
     ...
     * @param expectedColor -
     */
    @Given("{webElement} has color {color} of css-property {cssProperty}")
    @Given("{webElement} имеет цвет {color} css-свойства {cssProperty}")
     ...
     * @param expectedColor -
     */
    @Given("{webElement} does not have color {color} of css-property {cssProperty}")
    @Given("{webElement} не имеет цвет {color} css-свойства {cssProperty}")
     ...
     */
    @Given("{webElement} has dimensions {dimensions}")
    @Given("{webElement} имеет размеры {dimensions}")
     ...
     * @param expectedDimensions -
     */
    @Given("{webElement} does not have dimensions {dimensions}")
    @Given("{webElement} не имеет размеры {dimensions}")
     ...
     */
    @Given("{webElement} has location {location}")
    @Given("{webElement} находится в {location}")
     ...
     * @param expectedLocation -
     */
    @Given("component {webElementComponent} of the {webElement} has location {location}")
    @Given("компонент {webElementComponent} элемента {webElement} находится в {location}")
     ...
     * @param expectedLocation -
     */
    @Given("{webElement} does not have location {location}")
    @Given("{webElement} не находится в {location}")
     ...
     * @param expectedLocation -
     */
    @Given("component {webElementComponent} of the {webElement} does not have location {location}")
    @Given("компонент {webElementComponent} элемента {webElement} не находится в {location}")
