...
public class StringTextComparatorCucumberResolver implements StringValueComparatorCucumberResolver {
    ...
    public Optional<StringValueComparator> tryResolve(@NotNull String expression, @Nullable Object... args) {
        for (String pattern : patterns) {
            if (pattern.equalsIgnoreCase(expression)) {
                return Optional.of(StringTextComparator.defaultFormat());
            }
        }
