...
public class AvailableMobileMethods extends AvailableElementMethods {
    ...
    public static final String SHOULD_NOT_HAVE_BOUNDS_METHOD = "ShouldNotHaveBounds";
    public static final String SHOULD_NOT_HAVE_COLOR_METHOD = "ShouldNotHaveColor";
    public static final String SHOULD_NOT_HAVE_LABEL_METHOD = "ShouldNotHaveLabel";
