...
public class MobileDeviceActionNames {
    ...
    public static final String INSTALL_MOBILE_APPLICATION_METHOD = "InstallMobileApplication";                                  // pathToApplication
    ...
    public static final String SEND_MOBILE_APPLICATION_TO_BACKGROUND_METHOD = "SendMobileApplicationToBackground";              // duration.toString()
