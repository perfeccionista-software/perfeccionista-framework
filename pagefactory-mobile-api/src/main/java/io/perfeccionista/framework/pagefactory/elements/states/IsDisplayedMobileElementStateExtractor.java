...
public class IsDisplayedMobileElementStateExtractor implements MobileElementStateExtractor {
    public IsDisplayedMobileElementStateExtractor(@NotNull List<String> args) {
    }
        @Override
    public MobileElementOperation<Boolean> getOperation(@NotNull MobileChildElementBase element, Optional<MobileLocatorHolder> locatorHolder) {
            ...
            return MobileElementOperation.of(locatorChain, MobileGetIsDisplayedOperationType.of(element));
    }
}
