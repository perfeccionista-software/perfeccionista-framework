...
public class MobilePageIdentifier implements JsonSerializable {

    private final Set<String> names;
    private final Set<String> urls;
    private String lastUsedName = null;

    private MobilePageIdentifier(Set<String> names, Set<String> urls) {
        this.names = names;
        this.urls = urls;
    }

    public static MobilePageIdentifier of(Set<String> names, Set<String> urls) {
        return new MobilePageIdentifier(names, urls);
    }

    public static MobilePageIdentifier of(Class<? extends MobilePage> pageClass) {
