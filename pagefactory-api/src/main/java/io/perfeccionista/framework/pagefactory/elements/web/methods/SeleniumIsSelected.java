...
public class SeleniumIsSelected implements ElementMethodImplementation<Boolean> {

    public OperationResult<Boolean> execute(ChildElement element, Object... args) {
        DriverJsOperation<WebElement> operation = DriverJsOperation.of(element.getLocatorChainTo(SELECTED), GetWebElement.class);
