...
import static io.perfeccionista.framework.invocation.wrappers.LogicActionWrapper.runLogic;
...
/**
 * TODO: Добавить проверки для всех методов для каждого элемента и для каждого should
 *  State
 *  Bounds
 *  Screenshot
 *  Present
...
public class ElementsTest extends AbstractUiTest {
...
//
//    /**
//     * Case: Проверить что испанский флаг на главной странице отображается
//     * @param env - Экземпляр окружения теста
//     * @param value - Экземпляр сервиса значений
//     */
//    @Test
//    void webImageTest(Environment env, ValueService value) {
//        HomePage homePage = initWebPageContext(env, value).getPage(HomePage.class);
//        homePage.flagsFirstGroup()
//                .shouldBeDisplayed();
//    }
//
//    /**
...
//                .filter(with(WebConditions.containsLabel(value.stringContains("Label"))))
//                .shouldHaveSize(value.intEquals(3))
//                .extractAll(selectedMark());
//
...
//
//        ElementsPage elementsPage = pc.getPage(ElementsPage.class);
//        deleteIgnoreExceptions(Path.of(value.stringProcess("${[props] downloadedFileName}")));
...
//
//    /**
//     * Case: Выполняем двойной клик на текстовом блоке
//     *  Проверяем что текст о выполнении двойного клика отобразился
//     * @param env - Экземпляр окружения теста
//     * @param value - Экземпляр сервиса значений
//     */
//    @Test @Tag(FLUENT)
//    void elementActionTest(Environment env, ValueService value) {
//        WebPageContext pc = initWebPageContext(env, value);                                                // устанавливаем контекст страницы
//        HomePage homePage = pc.getPage(HomePage.class);
//        homePage.leftMenu()
//                .select(value.stringEquals("Elements"));
//
//        ElementsPage elementsPage = pc.getPage(ElementsPage.class);
//        elementsPage.doubleClickBlock()
//                .executeAction("DoubleClick");
//        elementsPage.textBlockForDoubleClickBlock()
//                .shouldHaveText(value.stringEquals("Double click performed"));
//    }
//
//    /**
//     * Case: Выполняем перетаскивание элемента source на элемент target
//     *  Проверяем что текст о выполнении перетаскивания отобразился
//     * @param env - Экземпляр окружения теста
//     * @param value - Экземпляр сервиса значений
//     */
//    @Test @Tag(FLUENT)
//    void elementInteractionTest(Environment env, ValueService value) {
//        WebPageContext pc = initWebPageContext(env, value);                                                // устанавливаем контекст страницы
//        HomePage homePage = pc.getPage(HomePage.class);
//        homePage.leftMenu()
//                .select(value.stringEquals("Elements"));
//
//        ElementsPage elementsPage = pc.getPage(ElementsPage.class);
//        elementsPage.dragAndDropSource()
//                .executeInteraction("Drag&Drop", elementsPage.dragAndDropTarget());
//        elementsPage.textBlockForDragAndDrop()
//                .shouldHaveText(value.stringEquals("Drag&Drop performed"));
//    }
