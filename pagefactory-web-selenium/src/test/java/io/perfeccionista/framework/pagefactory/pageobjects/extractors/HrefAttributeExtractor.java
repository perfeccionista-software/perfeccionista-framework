...
public class HrefAttributeExtractor implements WebElementPropertyExtractor<WebChildElement> {
    ...
    public String extract(@NotNull WebChildElement element, Optional<WebLocatorHolder> locatorHolder) {
        ...
        JsOperation<String> operation = JsOperation.of(locatorChain, new GetAttribute("href"));
