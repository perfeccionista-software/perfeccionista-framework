...
public class NameAttributeExtractor implements WebElementPropertyExtractor<WebChildElement> {
    ...
    public String extract(@NotNull WebChildElement element, Optional<WebLocatorHolder> locatorHolder) {
        ...
        JsOperation<String> operation = JsOperation.of(locatorChain, new GetAttribute("name"));
