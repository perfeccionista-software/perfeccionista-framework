...
public class PlaceholderAttributeExtractor implements WebElementPropertyExtractor<WebChildElement> {
    ...
    public String extract(@NotNull WebChildElement element, Optional<WebLocatorHolder> locatorHolder) {
        ...
        JsOperation<String> operation = JsOperation.of(locatorChain, new GetAttribute("placeholder"));
