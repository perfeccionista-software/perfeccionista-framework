...
public class TableTest extends AbstractUiTest {
    ...
    void tableTest(Environment env, ValueService value) {
        ...
        tablePage.table()
                .extractAllRows(cell(TablePage.SHORT_NAME, ShortNameWebMappedBlock.class))
                .shouldHaveSize(value.intEquals(195))
...
//                .shouldHaveIndex(value.intContainsAny(asList(100, 200, 300, 400, 500)));
        ...
        tablePage.table()
                .extractAllRows(WebExtractors.textValue(TablePage.NUMBER, from(CountryNumberWebMappedBlock.class).number()))
                .shouldHaveSize(value.intEquals(193));
        ...
        tablePage.table()
                .extractAllRows(WebExtractors.propertyValue(TablePage.SHORT_NAME, from(ShortNameWebMappedBlock.class).shortName(), "Wiki link"))
                .shouldHaveSize(value.intEquals(193));
        ...
        tablePage.table()
                .extractAllRows(WebExtractors.textValue(TablePage.SHORT_NAME, from(ShortNameWebMappedBlock.class).shortName()))
        ...
        MultipleResult<ShortNameWebMappedBlock> filteredByIndexBlocks = tablePage.table()
        ...
        SingleResult<ShortNameWebMappedBlock> filteredByIndexBlock = tablePage.table()
                .filter(with(rowIndex(value.intEquals(122))))
                .shouldHaveSize(value.intEquals(1))
                .extractOneRow(cell(TablePage.SHORT_NAME, ShortNameWebMappedBlock.class));
        ...
        tablePage.table()
                .filter(with(WebConditions.containsText(TablePage.SHORT_NAME, from(ShortNameWebMappedBlock.class).shortName(), value.stringContains("gia"))))
        ...
        tablePage.table()
                .filter(with(WebConditions.containsText(TablePage.NUMBER, from(CountryNumberWebMappedBlock.class).number(), value.intLessThanOrEqual(77))))
        ...
        MultipleResult<CountryNumberWebMappedBlock> filteredByMultipleConditionsBlocks = tablePage.table()
                ...
                .extractAllRows(cell(TablePage.SHORT_NAME, CountryNumberWebMappedBlock.class));
        ...
        MultipleResult<CountryNumberWebMappedBlock> filteredByMultipleConditionsBlocksByName = tablePage.table()
                ...
                .extractAllRows(cell(TablePage.NUMBER, CountryNumberWebMappedBlock.class));
