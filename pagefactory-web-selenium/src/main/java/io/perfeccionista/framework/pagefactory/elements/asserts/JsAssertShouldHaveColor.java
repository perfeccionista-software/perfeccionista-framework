...
public class JsAssertShouldHaveColor implements WebElementActionImplementation<Void> {
    ...
    public Void execute(WebChildElement element, Object... args) {
        ...
        throw new ElementColorException(ELEMENT_COLOR_IS_NOT_EQUAL_EXPECTED_COLOR.getMessage(component))
                .setType(ASSERT)
                .setProcessed(true)
