...
public class WebTextBlockSeleniumImpl extends AbstractWebChildElement implements WebTextBlock {
    ...
    @Override
    public WebTextBlock should(WebAssertCondition assertCondition) {
        super.should(assertCondition);
        return this;
    }

    @Override
    public WebTextBlock should(WebAssertCondition assertCondition, InvocationName invocationName) {
    ...
    @Override
    public WebTextBlock shouldBeDisplayed() {
        super.shouldBeDisplayed();
        return this;
    }

    @Override
    public WebTextBlock shouldNotBeDisplayed() {
    ...
    @Override
    public WebTextBlock shouldBeInFocus() {
        super.shouldBeInFocus();
        return this;
    }

    @Override
    public WebTextBlock shouldNotBeInFocus() {
    ...
    @Override
    public WebTextBlock shouldBePresent() {
        super.shouldBePresent();
        return this;
    }

    @Override
    public WebTextBlock shouldNotBePresent() {
