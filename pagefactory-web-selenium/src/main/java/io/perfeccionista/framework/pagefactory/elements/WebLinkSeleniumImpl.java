...
public class WebLinkSeleniumImpl extends AbstractWebChildElement implements WebLink {
    ...
    @Override
    public WebLink should(WebAssertCondition assertCondition) {
        super.should(assertCondition);
        return this;
    }

    @Override
    public WebLink should(WebAssertCondition assertCondition, InvocationName invocationName) {
    ...
    @Override
    public WebLink shouldBeDisplayed() {
        super.shouldBeDisplayed();
        return this;
    }

    @Override
    public WebLink shouldNotBeDisplayed() {
    ...
    @Override
    public WebLink shouldBeInFocus() {
        super.shouldBeInFocus();
        return this;
    }

    @Override
    public WebLink shouldNotBeInFocus() {
    ...
    @Override
    public WebLink shouldBePresent() {
        super.shouldBePresent();
        return this;
    }

    @Override
    public WebLink shouldNotBePresent() {
