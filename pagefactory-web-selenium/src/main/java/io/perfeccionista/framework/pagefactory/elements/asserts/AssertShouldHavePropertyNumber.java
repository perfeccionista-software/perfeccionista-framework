...
public class AssertShouldHavePropertyNumber implements WebElementActionImplementation<Void> {
    ...
    public Void execute(WebChildElement element, Object... args) {
        ...
        throw new ElementPropertyValueException(ELEMENT_PROPERTY_DOES_NOT_CONTAIN_EXPECTED_VALUE.getMessage(propertyName))
                .setType(ASSERT)
                .setProcessed(true)
                .addAttachmentEntry(JsonAttachmentEntry.of("Element", element.toJson()))
                .addAttachmentEntry(StringAttachmentEntry.of("Value", expectedValue.toString()));
