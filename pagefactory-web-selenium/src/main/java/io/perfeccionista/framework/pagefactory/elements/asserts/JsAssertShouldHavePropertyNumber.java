...
public class JsAssertShouldHavePropertyNumber implements WebElementActionImplementation<Void> {
    ...
    public Void execute(WebChildElement element, Object... args) {
        ...
        throw new ElementPropertyValueException(ELEMENT_PROPERTY_DOES_NOT_CONTAIN_EXPECTED_VALUE.getMessage(elementPropertyHolder.getName()))
                .setType(ASSERT)
                .setProcessed(true)
