...
public class DoubleLessOrEqualsNumberChecker extends AbstractNumberChecker<Double> {

    private final Double expectedIntValue;

    public DoubleLessOrEqualsNumberChecker(@NotNull Double expectedIntValue) {
