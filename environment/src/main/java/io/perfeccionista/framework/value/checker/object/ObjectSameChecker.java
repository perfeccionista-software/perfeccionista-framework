...
public class ObjectSameChecker extends AbstractObjectChecker {

    private final Object expectedValue;

    public ObjectSameChecker(@NotNull Environment environment, @NotNull Object expectedValue) {
        super(environment);
    ...
    public boolean check() {
        return getProcessedActual() == getProcessedExpected();
    }
