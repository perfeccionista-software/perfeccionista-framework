...
public class BigDecimalEqualsNumberChecker extends AbstractNumberChecker<BigDecimal> {

    private final BigDecimal expectedIntValue;

    public BigDecimalEqualsNumberChecker(@NotNull BigDecimal expectedIntValue) {
