...
public class BigDecimalGreaterOrEqualsNumberChecker extends AbstractNumberChecker<BigDecimal> {

    private final BigDecimal expectedIntValue;

    public BigDecimalGreaterOrEqualsNumberChecker(@NotNull BigDecimal expectedIntValue) {
