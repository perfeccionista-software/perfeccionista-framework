 ...
 * TODO: JavaDoc
 */
public class MultipleAttemptInvocationRunner implements InvocationRunner {
    private static final Logger logger = LoggerFactory.getLogger(MultipleAttemptInvocationRunner.class);
