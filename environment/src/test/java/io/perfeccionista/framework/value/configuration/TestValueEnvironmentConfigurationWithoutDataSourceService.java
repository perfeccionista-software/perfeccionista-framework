...
public class TestValueEnvironmentConfigurationWithoutDataSourceService implements EnvironmentConfiguration {

    private final InvocationRunnerConfiguration actionRunnerConfiguration;
    private final RepeatPolicy repeatPolicy;
    private final Timeouts timeouts;

    public TestValueEnvironmentConfigurationWithoutDataSourceService() {
