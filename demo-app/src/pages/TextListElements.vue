<template>
    <div id="text-list-elements-page">
        <b-container>
            <b-row>
            ...
            <b-row class="mb-3 text-center" align-v="center">
                <b-col cols="3">
                    <label class="mt-1">Выбор страны</label>
                </b-col>
                <b-col cols="9">
                    <b-form-input id="text-autocomplete" list="text-autocomplete-list"></b-form-input>
                    <datalist id="text-autocomplete-list">
                        <option v-for="country in countriesData">{{ country.name }}</option>
                    </datalist>
                </b-col>
            </b-row>
            ...
            <b-row class="mb-3 text-center" align-v="center">
                <b-col cols="3">
                    <label class="mt-1">Список стран</label>
                </b-col>
                <b-col cols="9">
