    ...
    <div id="list-elements-page">
        <b-container>
            ...
            <b-row class="mb-3 text-center" align-v="center">
                <b-col cols="12">
                    <b-button variant="info" @click="makeToast(true)" block>Create Popup</b-button>
                </b-col>
            </b-row>
    ...
    export default {
        ...
        methods: {
            makeToast: function(append) {
                this.toastCount++
                this.$bvToast.toast('This is popup message with number ' + this.toastCount, {
                    title: 'New message',
                    autoHideDelay: 5000,
                    appendToast: append
                })
