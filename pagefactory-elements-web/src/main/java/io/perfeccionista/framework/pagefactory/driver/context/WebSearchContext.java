...
public class WebSearchContext<T extends WebParentElement> {
    ...
    public <T extends Element> T element(String elementPath, Class<T> elementClass) {

        return null;
    }

    public IsDisplayedAvailable displayableElement(String elementPath) {

        return null;
    }


    public GetTextAvailable textElement(String elementPath) {
