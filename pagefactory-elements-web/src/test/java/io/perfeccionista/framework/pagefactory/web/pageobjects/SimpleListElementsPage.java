...
import io.perfeccionista.framework.pagefactory.elements.WebStringAutocomplete;
import io.perfeccionista.framework.pagefactory.elements.WebStringDropDownList;
...
public interface SimpleListElementsPage extends AbstractWebPage {
    ...
    WebStringDropDownList simpleDropDownList();

    @WebLocator(elementChecks = {IsDisplayedCheck.class})
    WebStringAutocomplete simpleAutocomplete();

    @WebLocator(elementChecks = {IsDisplayedCheck.class})
    WebStringList simpleUnorderedList();
